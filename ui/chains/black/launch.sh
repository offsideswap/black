...
blackfuryd init test --chain-id=offsideswap-local
...
blackfuryd gentx ${SHADOWFIEND_NAME} 1000000000000000000000000stake --chain-id=offsideswap-local --keyring-backend test
