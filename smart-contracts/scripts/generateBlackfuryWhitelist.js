 ...
 *
 * Finally, run
 * $ npx hardhat run scripts/generateBlackfuryWhitelist.js --network mainnet
 */
...
const blackfuryDS = require("../data/ds_blackfury_whitelist.json");
...
async function main() {
  ...
  for (let i = 0; i < addressList.length; i++) {
    try {
      ...
      const obj = _.cloneDeep(blackfuryDS);
