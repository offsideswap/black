...
func (c CLI) DaemonPath() (*string, error) {
	return c.shellExec("which", "blackfuryd")
}

func (c CLI) ResetState(nodeDir string) (*string, error) {
	return c.shellExec("blackfuryd", "unsafe-reset-all", "--home", nodeDir)
}
...
func (c CLI) NodeID(nodeDir string) (*string, error) {
	return c.shellExec("blackfuryd", "tendermint", "show-node-id", "--home", nodeDir)
}

func (c CLI) ValidatorAddress(nodeDir string) (*string, error) {
	return c.shellExec("blackfuryd", "tendermint", "show-validator", "--home", nodeDir)
}

func (c CLI) ValidatorConsensusAddress(nodeDir string) (*string, error) {
	return c.shellExec("blackfuryd", "tendermint", "show-address", "--home", nodeDir)
}

func (c CLI) InitChain(chainID, moniker, nodeDir string) (*string, error) {
	return c.shellExec("blackfuryd", "init", moniker, "--chain-id", chainID, "--home", nodeDir)
}
...
func (c CLI) AddKey(name, mnemonic, keyPassword, cliDir string) (*string, error) {
	...
	default:
		...
		return c.shellExecInput("blackfuryd", input, "keys", "add", name, "--home", cliDir, "-i", "--keyring-backend", c.keyringBackend)
	}
}

func (c CLI) AddGenesisAccount(address, nodeDir string, coins []string) (*string, error) {
	return c.shellExec("blackfuryd", "add-genesis-account", address, strings.Join(coins[:], ","), "--home", nodeDir)
}

func (c CLI) AddGenesisCLPAdmin(address, nodeDir string) (*string, error) {
	return c.shellExec("blackfuryd", "add-genesis-clp-admin", address, "--home", nodeDir, "--keyring-backend", c.keyringBackend)
}

func (c CLI) SetGenesisOracleAdmin(address, nodeDir string) (*string, error) {
	return c.shellExec("blackfuryd", "set-genesis-oracle-admin", address, "--home", nodeDir, "--keyring-backend", c.keyringBackend)
}

func (c CLI) SetGenesisWhitelisterAdmin(address, nodeDir string) (*string, error) {
	return c.shellExec("blackfuryd", "set-genesis-whitelister-admin", address, "--home", nodeDir, "--keyring-backend", c.keyringBackend)
}
...
func (c CLI) GenerateGenesisTxn(name, keyPassword, bondAmount, nodeDir, outputFile, nodeID, pubKey, ipV4Addr, chainID string) (*string, error) {
	...
	return c.shellExecInput("blackfuryd", input,
...
func (c CLI) CollectGenesisTxns(gentxDir, nodeDir string) (*string, error) {
	return c.shellExec("blackfuryd", "collect-gentxs", "--gentx-dir", gentxDir, "--home", nodeDir)
}

func (c CLI) ExportGenesis() (*string, error) {
	return c.shellExec("blackfuryd", "export")
}
...
func (c CLI) TransferFunds(keyPassword, fromAddress, toAddress, coins string) (*string, error) {
	...
	return c.shellExecInput("blackfuryd", input, "tx", "send", fromAddress, toAddress, coins, "-y")
}

func (c CLI) ValidatorPublicKeyAddress() (*string, error) {
	return c.shellExec("blackfuryd", "tendermint", "show-validator")
}
