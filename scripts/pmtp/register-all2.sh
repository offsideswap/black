...
blackfuryd tx tokenregistry register denoms/cgala.json \
  --node ${BLACKFURY_NODE} \
...
# blackfuryd tx tokenregistry register denoms/ujuno.json \
#   --node ${BLACKFURY_NODE} \
#   --chain-id "${BLACKFURY_CHAIN_ID}" \
#   --from "${ADMIN_ADDRESS}" \
#   --keyring-backend test \
...
# blackfuryd tx tokenregistry register denoms/uluna.json \
#   --node ${BLACKFURY_NODE} \
#   --chain-id "${BLACKFURY_CHAIN_ID}" \
#   --from "${ADMIN_ADDRESS}" \
#   --keyring-backend test \
