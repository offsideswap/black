...
func (s *IntegrationTestSuite) SetupSuite() {
	...
	cfg.NumValidators = 1
	encConfig := blackapp.MakeTestEncodingConfig()
	...
	// 	db := dbm.NewMemDB()
	// 	return blackapp.NewBlackApp(log.NewTMLogger(log.NewSyncWriter(os.Stdout)), db, nil, true, map[int64]bool{}, val.Dir, 0, encConfig, blackapp.EmptyAppOptions{})
	// }
