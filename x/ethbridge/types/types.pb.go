...
// source: blackfury/ethbridge/v1/types.proto
...
type EthBridgeClaim struct {
	...
	ClaimType        ClaimType                              `protobuf:"varint,10,opt,name=claim_type,json=claimType,proto3,enum=blackfury.ethbridge.v1.ClaimType" json:"claim_type,omitempty"`
}
...
func init() {
	proto.RegisterEnum("blackfury.ethbridge.v1.ClaimType", ClaimType_name, ClaimType_value)
	proto.RegisterType((*EthBridgeClaim)(nil), "blackfury.ethbridge.v1.EthBridgeClaim")
	proto.RegisterType((*PeggyTokens)(nil), "blackfury.ethbridge.v1.PeggyTokens")
	proto.RegisterType((*GenesisState)(nil), "blackfury.ethbridge.v1.GenesisState")
	proto.RegisterType((*Pause)(nil), "blackfury.ethbridge.v1.Pause")
}

func init() { proto.RegisterFile("blackfury/ethbridge/v1/types.proto", fileDescriptor_4cb34f678c9ed59f) }
