...
// source: blackfury/tokenregistry/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryEntriesResponse)(nil), "blackfury.tokenregistry.v1.QueryEntriesResponse")
	proto.RegisterType((*QueryEntriesRequest)(nil), "blackfury.tokenregistry.v1.QueryEntriesRequest")
}

func init() {
	proto.RegisterFile("blackfury/tokenregistry/v1/query.proto", fileDescriptor_c311bc06126a6f47)
}
...
func (c *queryClient) Entries(ctx context.Context, in *QueryEntriesRequest, opts ...grpc.CallOption) (*QueryEntriesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blackfury.tokenregistry.v1.Query/Entries", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Entries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blackfury.tokenregistry.v1.Query/Entries",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "blackfury.tokenregistry.v1.Query",
	...
	Metadata: "blackfury/tokenregistry/v1/query.proto",
}
