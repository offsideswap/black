...
// source: blackfury/tokenregistry/v1/types.proto
...
type RegistryEntry struct {
	...
	Permissions              []Permission `protobuf:"varint,15,rep,packed,name=permissions,proto3,enum=blackfury.tokenregistry.v1.Permission" json:"permissions,omitempty"`
...
func init() {
	proto.RegisterEnum("blackfury.tokenregistry.v1.Permission", Permission_name, Permission_value)
	proto.RegisterType((*GenesisState)(nil), "blackfury.tokenregistry.v1.GenesisState")
	proto.RegisterType((*Registry)(nil), "blackfury.tokenregistry.v1.Registry")
	proto.RegisterType((*RegistryEntry)(nil), "blackfury.tokenregistry.v1.RegistryEntry")
}

func init() {
	proto.RegisterFile("blackfury/tokenregistry/v1/types.proto", fileDescriptor_d08afdaf425e66ea)
}
