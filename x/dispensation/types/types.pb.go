...
// source: blackfury/dispensation/v1/types.proto
...
type DistributionRecord struct {
	DistributionStatus          DistributionStatus                       `protobuf:"varint,1,opt,name=distribution_status,json=distributionStatus,proto3,enum=blackfury.dispensation.v1.DistributionStatus" json:"distribution_status,omitempty"`
	DistributionType            DistributionType                         `protobuf:"varint,2,opt,name=distribution_type,json=distributionType,proto3,enum=blackfury.dispensation.v1.DistributionType" json:"distribution_type,omitempty"`
...
type Distribution struct {
	DistributionType DistributionType `protobuf:"varint,1,opt,name=distribution_type,json=distributionType,proto3,enum=blackfury.dispensation.v1.DistributionType" json:"distribution_type,omitempty"`
...
type UserClaim struct {
	...
	UserClaimType DistributionType                          `protobuf:"varint,2,opt,name=user_claim_type,json=userClaimType,proto3,enum=blackfury.dispensation.v1.DistributionType" json:"user_claim_type,omitempty"`
...
func init() {
	proto.RegisterEnum("blackfury.dispensation.v1.DistributionType", DistributionType_name, DistributionType_value)
	proto.RegisterEnum("blackfury.dispensation.v1.DistributionStatus", DistributionStatus_name, DistributionStatus_value)
	proto.RegisterType((*GenesisState)(nil), "blackfury.dispensation.v1.GenesisState")
	proto.RegisterType((*DistributionRecord)(nil), "blackfury.dispensation.v1.DistributionRecord")
	proto.RegisterType((*DistributionRecords)(nil), "blackfury.dispensation.v1.DistributionRecords")
	proto.RegisterType((*Distributions)(nil), "blackfury.dispensation.v1.Distributions")
	proto.RegisterType((*Distribution)(nil), "blackfury.dispensation.v1.Distribution")
	proto.RegisterType((*UserClaim)(nil), "blackfury.dispensation.v1.UserClaim")
	proto.RegisterType((*UserClaims)(nil), "blackfury.dispensation.v1.UserClaims")
	proto.RegisterType((*MintController)(nil), "blackfury.dispensation.v1.MintController")
}

func init() {
	proto.RegisterFile("blackfury/dispensation/v1/types.proto", fileDescriptor_bfdf912039cd8799)
}
