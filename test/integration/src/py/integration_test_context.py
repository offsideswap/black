...
class IntegrationTestContext:
    ...
    @property
    def blackfuryd_node(self):
        return self.get_optional_var("BLACKFURY", None)

    @property
    def blackfury_base_dir(self):
        return self.get_required_var("BASEDIR")

    @property
    def smart_contracts_dir(self):
        return self.get_optional_var("SMART_CONTRACTS_DIR", os.path.join(self.blackfury_base_dir, "smart-contracts"))
    ...
    def is_ropsten_testnet(self):
        ...
        return bool(self.blackfuryd_node)
    ...
    def ganache_keys_file(self):
        return self.get_optional_var("GANACHE_KEYS_FILE",
            os.path.join(self.blackfury_base_dir, "test/integration/vagrant/data/ganachekeys.json"))
