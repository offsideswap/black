...
import string
import random
from dispensation_envutils import create_online_singlekey_txn, create_new_blackaddr_and_key, send_sample_fury, balance_check, \
...
def test_run_online_morethan10distribution_txn(claimType):
    distributor_address, distributor_name = create_new_blackaddr_and_key()
    runner_address, runner_name = create_new_blackaddr_and_key()
    ...
    destaddress1, destname1 = create_new_blackaddr_and_key()
    destaddress2, destname2 = create_new_blackaddr_and_key()
    destaddress3, destname3 = create_new_blackaddr_and_key()
    destaddress4, destname4 = create_new_blackaddr_and_key()
    destaddress5, destname5 = create_new_blackaddr_and_key()
    destaddress6, destname6 = create_new_blackaddr_and_key()
    destaddress7, destname7 = create_new_blackaddr_and_key()
    destaddress8, destname8 = create_new_blackaddr_and_key()
    destaddress9, destname9 = create_new_blackaddr_and_key()
    destaddress10, destname10 = create_new_blackaddr_and_key()
    destaddress11, destname11 = create_new_blackaddr_and_key()
    destaddress12, destname12 = create_new_blackaddr_and_key()
    from_address = 'blackfuryadmin'
