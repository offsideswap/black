...
from blacktool.blackchain import FURY, FURY_DECIMALS
...
class TestMargin:
    ...
    def test_swap_fury_to_external(self):
        with self.with_test_env(self.default_pool_setup) as (env, blackfuryd, pools_definitions):
            ...
            assert src_balance_delta == - (blackchain.black_tx_fee_in_fury + swap_amount)
    ...
    def test_swap_external_to_external(self):
        with self.with_test_env(self.default_pool_setup) as (env, blackfuryd, pools_definitions):
            ...
            assert fury_delta == -blackchain.black_tx_fee_in_fury
