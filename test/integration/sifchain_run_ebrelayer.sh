...
#
# Runs ebrelayer.  Normally, this is run by blackchain_start_ebrelayer.sh;
# that file sets up the logs and runs blackchain_run_ebrelayer in the background.
...
set_persistant_env_var EBRELAYER_DB "${TEST_INTEGRATION_DIR}/blackchainrelayerdb" $envexportfile
