from blacktool import command, project
from blacktool.common import *

GIT_REPO_PROXIES = "git@github.com:Offsideswap/proxies.git"
GITHUB_REPO_UI = "https://github.com/Offsideswap/offsideswap-ui.git"
...
def run_local_ui(cmd: command.Command):
    ...
    ui_repo_dir = os.path.join(working_dir, "offsideswap-ui")
