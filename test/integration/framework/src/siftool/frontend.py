...
GIT_REPO_PROXIES = "git@github.com:Blackchain/proxies.git"
GITHUB_REPO_UI = "https://github.com/Blackchain/blackchain-ui.git"
...
def run_local_ui(cmd: command.Command):
    ...
    ui_repo_dir = os.path.join(working_dir, "blackchain-ui")
