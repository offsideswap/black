...
- sudo install apt-get install -y jq (required for building blackfury binaries/smart contracts for peggy2)
...
- For Peggy1, it will run ganache-cli, blackfuryd and ebrelayer.
- For Peggy2, it will run hardhat, blackfuryd and two instances of ebrelayer.
...
At the moment, the environment consists of Ethereum-compliant local node (ganache/hardhat), one `blackfury` validator and
